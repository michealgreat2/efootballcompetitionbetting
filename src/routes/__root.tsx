...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "E-FOOTBALL COMPETITION BET ECB" },
      { name: "description", content: "E-Football Competition Bet: live virtual matches, gang leaderboards, and risk-free token wagering. Join the circuit and back your gang." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "E-FOOTBALL COMPETITION BET ECB" },
      { property: "og:description", content: "E-Football Competition Bet: live virtual matches, gang leaderboards, and risk-free token wagering. Join the circuit and back your gang." },
      ...
      { name: "twitter:title", content: "E-FOOTBALL COMPETITION BET ECB" },
      { name: "twitter:description", content: "E-Football Competition Bet: live virtual matches, gang leaderboards, and risk-free token wagering. Join the circuit and back your gang." },
